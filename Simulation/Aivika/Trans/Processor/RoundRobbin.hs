...
roundRobbinProcessor :: Comp m => Processor m (Process m Double, Process m a) a
roundRobbinProcessor =
  Processor $
...
roundRobbinProcessorUsingIds :: Comp m => Processor m (Process m (Double, ProcessId m), Process m a) a
